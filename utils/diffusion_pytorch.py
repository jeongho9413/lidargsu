"""
a video-based Palette with continuous time
...
# Variational Diffusion Models [Kingma +, 2021]
class ContinuousTimeGaussianDiffusion(nn.Module):
    def __init__(
        ...
        *, 
        image_size, 
        channels = 2,                     # default: 2 when depth channel
        frames = 10, 
    ...
    def p_sample(self, x, x_cond, time, time_next, sampler):
        ...
        if self.clip_sample_denoised:
            x_0.clamp_(-1., 1.)    # in Imagen, this was changed to dynamic thresholding
...
""" dataset for self-occlusion restoration with Palette """
class DatasetSusteck1kOcclusion(data.Dataset):
    def __init__(
        ...
        channels = 1, 
        frames = 10, 
        cfg_path='/home/jeongho9413/Downloads/git/SII2025_image-bsaed-palette/config/susteck1k/susteck1k.json', 
    ):
        super().__init__()
    ...
    def train(self):  
        while self.step < self.train_num_steps:
            ...
            if self.step != 0 and self.step % self.save_and_sample_every == 0:
                """ option3 (super-res) """
                y0_orig_path = '/home/jeongho9413/Downloads/datasets/susteck1k_projection_jeongho/ortho_depth-pos_drop-point_pkl/0001/00-nm/090/01-000-LiDAR-PCDs_depths_orig.pkl'
                y0_cond_p050_path = '/home/jeongho9413/Downloads/datasets/susteck1k_projection_jeongho/ortho_depth-pos_drop-point_pkl/0001/00-nm/090/41-000-LiDAR-PCDs_depths_p050.pkl'
                y0_cond_p033_path = '/home/jeongho9413/Downloads/datasets/susteck1k_projection_jeongho/ortho_depth-pos_drop-point_pkl/0001/00-nm/090/42-000-LiDAR-PCDs_depths_p033.pkl'
                y0_cond_p025_path = '/home/jeongho9413/Downloads/datasets/susteck1k_projection_jeongho/ortho_depth-pos_drop-point_pkl/0001/00-nm/090/43-000-LiDAR-PCDs_depths_p025.pkl'
